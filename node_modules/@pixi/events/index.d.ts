...
export declare const FederatedDisplayObject: Omit<FederatedEventTarget, 'parent' | 'children' | keyof utils.EventEmitter | 'cursor'>;
 ...
 * @memberof PIXI
 */
export declare interface FederatedEventTarget extends utils.EventEmitter, EventTarget {
