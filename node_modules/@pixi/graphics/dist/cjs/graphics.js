...
class ArcUtils {
  ...
  static arc(_startX, _startY, cx, cy, radius, startAngle, endAngle, _anticlockwise, points) {
    ...
    const n = GRAPHICS_CURVES._segmentsCount(Math.abs(sweep) * radius, Math.ceil(Math.abs(sweep) / core.PI_2) * 40);
...
const FILL_COMMANDS = {
  [core.SHAPES.POLY]: buildPoly,
  [core.SHAPES.CIRC]: buildCircle,
  [core.SHAPES.ELIP]: buildCircle,
  [core.SHAPES.RECT]: buildRectangle,
  [core.SHAPES.RREC]: buildRoundedRectangle
};
const BATCH_POOL = [];
